...
echo -e "It will guide you through the process of adding and removing aliases and will automate each actions for you\n"
echo "Basically, it will edit your .bashrc file and add or remove aliases for you (depending on what you asked for)"
echo -e "The .bashrc file is resourced after each actions for an immediate application, this way you do not need to logoff/logon to use your new aliases\n"
echo "A backup of your .bashrc file is created under your home directory before each actions"
